...
for (var i = 0; i < sites.length; i++) {
  ...
  L.marker(city.location)
    .bindPopup("<h1>" + city.name + "</h1> <hr> <h5> Number of Launches " + city.launches + "</h5> <hr> <h5> Info on Launch Site: " + city.info + "</h5>")
    .addTo(myMap);
}
